...
test.describe('Home E2E', () => {
    ...
    test('logs in and shows games subpage', async ({page}) => {
        ...
        // Home.jsx probes GET /users on boot to detect an existing session -- the first
        // call must report "not authenticated" so the login form renders instead of
        // being skipped; only the call made after the real login submit (below) should
