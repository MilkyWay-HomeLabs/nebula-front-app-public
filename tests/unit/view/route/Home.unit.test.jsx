...
beforeEach(async () => {
    ...
    UserDataRequest.mockReset();
    UserDataRequest.mockResolvedValue(null);
});
...
test('shows games after successful login', async () => {
    ...
    UserDataRequest.mockReset();
    UserDataRequest.mockResolvedValueOnce(null); // boot probe: no session yet
    UserDataRequest.mockResolvedValue({id: 1, login: 'testuser'}); // after login
